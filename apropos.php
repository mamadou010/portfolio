...
/* ============================================================
   ...
   Partie 3 : journalisation de la visite.
   ============================================================ */
...
enregistrer_visite($pdo, 'apropos.php');

$etapes_timeline = [
    ['cote'=>'gauche','date'=>'2024/2025 — Licence 1','titre'=>'Découverte du développement web','texte'=>'Apprentissage de HTML et CSS. Réalisation de mon premier portfolio statique et responsive.','actif'=>false],
    ['cote'=>'droite','date'=>'2025 — 2026','titre'=>'Programmation et bases de données','texte'=>'Développement en C, Java et Python. Prise en main de MySQL pour la gestion de données.','actif'=>false],
    ['cote'=>'gauche','date'=>'2025 — 2026','titre'=>'Systèmes embarqués & réseau','texte'=>'Projets pratiques en systèmes embarqués. Configuration de routeurs, adressage IP et routage dynamique.','actif'=>false],
    ['cote'=>'droite','date'=>"2026 — Aujourd'hui",'titre'=>'PHP, web avancé & affiliation','texte'=>'Développement PHP/MySQL, création de sites d\'affiliation et gestion de contenu SEO.','actif'=>true],
];
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <section class="section-presentation">
        <div class="presentation-photo">
            ...
            <div class="badge-photo"><i class="fas fa-graduation-cap"></i> Licence 2</div>
        </div>
        <div class="presentation-texte">
            <h2>Bonjour, je suis <span class="couleur-accent">Mamadou Ndiaye</span></h2>
            <p>Étudiant en Licence 2 en Génie Logiciel et Administration Réseau à l'École Supérieure de Technologie et de Management, je suis passionné par la création de solutions numériques.</p>
            <p>Je m'intéresse particulièrement au développement d'applications web et de logiciels, ainsi qu'à la création de contenu digital.</p>
            <p><strong>Ce qui me motive ?</strong> Transformer des idées en projets concrets, apprendre continuellement et repousser mes limites.</p>
            ...
            <a href="images/Cv Mamadou Ndiaye.pdf" download class="btn-principal" style="margin-top:1.5rem;display:inline-block;">
    ...
    <section class="section-timeline">
        ...
        <div class="timeline">
            <?php foreach ($etapes_timeline as $etape) :
    ...
    <section class="section-experiences">
        ...
        <div class="experiences-grille">
            <div class="experience-carte">
                ...
                <p>Création et gestion de deux sites web d'affiliation : <strong>meilleur-mixeur.com</strong> et <strong>mon-guide-petit-electromenager.com</strong>.</p>
                <div class="exp-tags">
            ...
            <div class="experience-carte">
                ...
                <p>Développer des projets web rentables et à fort impact.</p>
                <div class="exp-tags">
